...
C.1. How-To : Verify results and videos generated by eSLP without any setup/Falcon/compiler needed
...
a) Variable TotalResults includes time, states, control, cost.
b) Variable SolverStats includes the results from IPOPT. The [x,y,z] elements correspond to: 
