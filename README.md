...
C.2. How-To : Check results and videos generated by eSLP so far without setup/Falcon/compiler
1. Copy any folder's content and run FinalResults.m. First, we display the results and then a series of videos is generated.

C.3. How-To : Run examples
